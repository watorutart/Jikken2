...
class TestDeliveToHouse{
	...
	private void deliveToHouse() {
		...
		System.out.println("Debug: Protocol to house");
		// 相手識別
		// recognize opponent
		do {
		...
		// スレッドの開始
		// start thread
		//System.out.println("Debug: Multithread start.");
		
		//this.est.start(String.valueOf(this.adjust(Adjustment.clientHouseNameAddr)));

		// コネクション確立まで待機
		// wait until connection establish
		//System.out.println("Debug: waiting connection to House");
		//while (!this.telecommunication.isWaitThread());

		// multi-thread end
		//System.out.println("Debug: Connection has established with House");
		...
		System.out.println("Debug: Address has detected.  Go to House");
	...
	public static void main(){
		TestDeliveToHouse EV3=new TestDeliveToHouse();
